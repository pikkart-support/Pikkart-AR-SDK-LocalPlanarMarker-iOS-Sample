 ...
 * \endcode
 */
__attribute__((deprecated("it will be removed in future release. Use PKTRecognitionController class instead.")))
@interface PKTCameraController : PKTRecognitionController
